...
Tabalyst is in alpha. Commands and the JSON format may still change between
versions. This documentation describes the latest release published on PyPI.

## Start here

- [Install Tabalyst](how-to/install.md), on Windows, macOS or Linux.
